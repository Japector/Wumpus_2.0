...
class SetDirectionTest {
    ...
    private final SetDirection underTest = new SetDirection() ;

    @Test
    void testCanProcessShouldReturnTrueWhenGetsTheCorrectInput() {
        //Given
        String input ="DIRECTION E";
    ...
    @Test
    void testProcessShouldCorrectlySetDirectionWhenCalled() {
        ...
        underTest.canProcess("DIRECTION E");
        ...
        Assertions.assertEquals( 'E', actual.getHero().getDirection());
